  ...
  const info = {
      ...
      parameters: {
          ...
          instructions: {
              ...
              default: `
            <p>Расположите вашу голову так, чтобы она попадала ровно в рамку.</p>
            <p>Посмотрите прямо в камеру.</p>
            <p>Пожалуйста, держите голову примерно в этом же положении на протяжении всего эксперимента.</p>
            <p>Когда камера распознает Ваше лицо, рамка станет зелёного цвета и на лице появится "маска" из точек. После этого нажмите кнопку "Продолжить"</p>`,
          },
